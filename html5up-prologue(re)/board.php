...
$sql16="select Room_ID from room where place_ID=6 or place_ID=7";
								...
								for($i=0;$i<$rm_count;$i++)
									{
										...
										echo"<article class=\"item\">
											<a href=\"#\" class=\"image fit\" onclick=\"room_id($rooms11[$i])\"><img src=\"image/1-$rooms[$i].jpg\" alt=\"\" /></a>
											<header>
											<h3>$rooms[$i]</h3>
											</header>
											</article>";
							...
							<div class="row">
								<?php
									for($i=0;$i<$rm2_count;$i++)
									{
										echo"<div class=\"4u 12u$(mobile)\">";
										echo"<article class=\"item\">
											<a href=\"#\" class=\"image fit\" onclick=\"room_id($rooms12[$i])\"><img src=\"image/8-$rooms2[$i].jpg\" alt=\"\" /></a>
											<header>
											<h3>$rooms2[$sum2]</h3>
											</header>
											</article>";
							...
							<div class="row">
								<?php
									for($i=0;$i<$rm3_count;$i++)
									{
										echo"<div class=\"4u 12u$(mobile)\">";
										echo"<article class=\"item\">
											<a href=\"#\" class=\"image fit\" onclick=\"room_id($rooms13[$i])\"><img src=\"image/3-$rooms3[$i].jpg\" alt=\"\" /></a>
											<header>
											<h3>$rooms3[$i]</h3>
											</header>
											</article>";
							...
							<div class="row">
								<?php
									for($i=0;$i<$rm4_count;$i++)
									{
										echo"<div class=\"4u 12u$(mobile)\">";
										echo"<article class=\"item\">
											<a href=\"#\" class=\"image fit\" onclick=\"room_id($rooms14[$i])\"><img src=\"image/4-$rooms4[$i].jpg\" alt=\"\" /></a>
											<header>
											<h3>$rooms4[$i]</h3>
											</header>
											</article>";
							...
							<div class="row">
								<?php
									for($i=0;$i<$rm6_count;$i++)
									{
										echo"<div class=\"4u 12u$(mobile)\">";
										echo"<article class=\"item\">
											<a href=\"#\" class=\"image fit\" onclick=\"room_id($rooms16[$i])\"><img src=\"image/6-$rooms6[$i].jpg\" alt=\"\" /></a>
											<header>
											<h3>$rooms6[$i]</h3>
											</header>
											</article>";
							...
							<div class="row">
								<?php
									for($i=0;$i<$rm5_count;$i++)
									{
										echo"<div class=\"4u 12u$(mobile)\">";
										echo"<article class=\"item\">
											<a href=\"#\" class=\"image fit\" onclick=\"room_id($rooms15[$i])\"><img src=\"image/5-$rooms5[$i].jpg\" alt=\"\" /></a>
											<header>
											<h3>$rooms5[$i]</h3>
											</header>
											</article>";
