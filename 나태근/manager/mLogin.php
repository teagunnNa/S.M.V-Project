				...
				<div class="top">
					...
					<!-- Nav -->
						<nav id="nav">
							...
							-->
							<ul>
								<li><a href="#top" id="top-link" class="skel-layers-ignoreHref"><span class="icon fa-home">관리자 로그인</span></a></li>
							</ul>
						</nav>
					...
					<section id="top" class="one dark cover">
						<div class="container">
							...
							<header>
								...
								<center><input type="submit" value="관리자 로그인"/><br/>
