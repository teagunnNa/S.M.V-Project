...
<html>
	...
	for(var i = 0; i < week; i++) {
		...
		for(var j = 0; j < 7; j++, dateNum++) {
			...
			calendar += '<td class="' + dateString[j] + '">' + '<a href="javascript:PopWin1(\'qqqqq.php\', \'310\', \'400\', \'no\');" onclick="button1_click(\'' + (currentYear*10000 + currentMonth*100 + dateNum) + '\');">' + dateNum + '</td>';
		}
		calendar += '</tr>';
	}
	calendar += '</tbody>';
	...
	kCalendar.innerHTML = calendar;
		...
		<div id="kCalendar">
		<script>
			window.onload =	kCalendar('kCalendar');
		</script>
		</div>
	</body>
</html>
