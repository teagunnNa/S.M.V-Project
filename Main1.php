...
mysql_select_db("smr");
$result = mysql_query("delete from reservation where Date < $date");
					...
					<!-- Nav -->
						<nav id="nav">
							...
							<ul>
								...
								<li><a href="/Status/StatusMapOut.php" id="sta-link" class="skel-layers-ignoreHref"><span class="icon fa-clock-o">예약 현황 확인</span></a></li>
							</ul>
						</nav>
				...
				<div class="bottom">
					...
					<!-- Social Icons -->
						<ul class="icons">
							...
							<li><a href="login/signup.php" class="icon fa-sign-in"><span class="label">signin</span></a></li>
								...
								for($i=0;$i<$rm_count;$i++)
									{
										...
										echo"<article class=\"item\">
											<a href=\"#\" class=\"image fit\" onclick=\"print_error()\"><img src=\"image/1-$rooms[$i].jpg\" alt=\"\" /></a>
											<header>
											<h3>$rooms[$i]</h3>
											</header>
											</article>";
							...
							<div class="row">
								<?php
									for($i=0;$i<$rm2_count;$i++)
									{
										echo"<div class=\"4u 12u$(mobile)\">";
										echo"<article class=\"item\">
											<a href=\"#\" class=\"image fit\" onclick=\"print_error()\"><img src=\"image/8-$rooms2[$i].jpg\" alt=\"\" /></a>
											<header>
											<h3>$rooms2[$sum2]</h3>
											</header>
											</article>";
							...
							<div class="row">
								<?php
									for($i=0;$i<$rm3_count;$i++)
									{
										echo"<div class=\"4u 12u$(mobile)\">";
										echo"<article class=\"item\">
											<a href=\"#\" class=\"image fit\" onclick=\"print_error()\"><img src=\"image/3-$rooms3[$i].jpg\" alt=\"\" /></a>
											<header>
											<h3>$rooms3[$i]</h3>
											</header>
											</article>";
							...
							<div class="row">
								<?php
									for($i=0;$i<$rm4_count;$i++)
									{
										echo"<div class=\"4u 12u$(mobile)\">";
										echo"<article class=\"item\">
											<a href=\"#\" class=\"image fit\" onclick=\"print_error()\"><img src=\"image/4-$rooms4[$i].jpg\" alt=\"\" /></a>
											<header>
											<h3>$rooms4[$i]</h3>
											</header>
											</article>";
							...
							<div class="row">
								<?php
									for($i=0;$i<$rm6_count;$i++)
									{
										echo"<div class=\"4u 12u$(mobile)\">";
										echo"<article class=\"item\">
											<a href=\"#\" class=\"image fit\" onclick=\"print_error()\"><img src=\"image/6-$rooms6[$i].jpg\" alt=\"\" /></a>
											<header>
											<h3>$rooms6[$i]</h3>
											</header>
											</article>";
							...
							<div class="row">
								<?php
									for($i=0;$i<$rm5_count;$i++)
									{
										echo"<div class=\"4u 12u$(mobile)\">";
										echo"<article class=\"item\">
											<a href=\"#\" class=\"image fit\" onclick=\"print_error()\"><img src=\"image/5-$rooms5[$i].jpg\" alt=\"\" /></a>
											<header>
											<h3>$rooms5[$i]</h3>
											</header>
											</article>";
